    ...
    @if ($estaEditando)
        <div class="max-w-lg mx-auto bg-gray-800 p-6 rounded-lg shadow-lg">
            <form wire:submit.prevent="actualizar">
                <div class="mb-4">
                    <label for="nombre" class="block text-sm font-medium text-gray-300">Editar Nombre:</label>
                    <input wire:model="nombre" type="text" id="nombre" name="nombre"
        ...
        <table class="w-full text-left text-gray-300">
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-700 hover:bg-gray-700">
                    <td class="px-4 py-2">
                        <a href="#" wire:click="ver({{ $alumno->id }})" class="bg-green-500 text-white px-2 py-1 rounded cursor-pointer">
                            {{ $alumno->nombre}}
                        </a>
                    </td>
